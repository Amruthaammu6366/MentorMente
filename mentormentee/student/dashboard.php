...
<div class="container mt-5">
    <h2 class="mb-4 fw-bold text-center text-primary">Welcome, Student!</h2>
        ...
        <div class="col-md-4">
            <a href="studyplan.php" class="text-decoration-none">
                <div class="card shadow-lg border-0 p-4 text-center bg-light h-100">
                    ...
                    <h5 class="fw-bold">View Study Plan</h5>
                    <p class="small text-muted">See all study plans from your faculty.</p>
                </div>
            </a>
        </div>
        <div class="col-md-4">
            <a href="assignment.php" class="text-decoration-none">
                <div class="card shadow-lg border-0 p-4 text-center bg-light h-100">
                    ...
                    <h5 class="fw-bold">View Assignments</h5>
                    <p class="small text-muted">View and submit assignments for your semester.</p>
                </div>
            </a>
        </div>
        <div class="col-md-4">
            <a href="resources.php" class="text-decoration-none">
                <div class="card shadow-lg border-0 p-4 text-center bg-light h-100">
                    ...
                    <h5 class="fw-bold">View Resources</h5>
                    <p class="small text-muted">Access and download study resources.</p>
                </div>
            </a>
        </div>
        <div class="col-md-4">
            <a href="marks.php" class="text-decoration-none">
                <div class="card shadow-lg border-0 p-4 text-center bg-light h-100">
                    ...
                    <p class="small text-muted">See your academic marks.</p>
                </div>
            </a>
        </div>
        <div class="col-md-4">
            <a href="attendance.php" class="text-decoration-none">
                <div class="card shadow-lg border-0 p-4 text-center bg-light h-100">
                    ...
                    <p class="small text-muted">Check your attendance records.</p>
                </div>
            </a>
        </div>
    </div>
