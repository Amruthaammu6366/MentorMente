...
$marks = $conn->query("SELECT m.*, f.name as faculty_name FROM marks m JOIN faculty f ON m.faculty_id = f.id WHERE m.student_id = $student_id ORDER BY m.date DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container mt-4">
    ...
    <div class="card p-4 mb-4 mt-5">
        <table class="table table-bordered bg-white">
            <thead>
                <tr>
                    <th>Test Name</th><th>Date</th><th>Semester</th><th>Marks Obtained</th><th>Total Marks</th><th>Faculty</th>
                </tr>
            </thead>
            <tbody>
